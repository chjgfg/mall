...
public class Constants {
  ...
  public final static int INDEX_GROUP_NUMBER = 10;//首页拼单商品数量
  public final static String GROUP_TO_REDIS = "拼单成功";
  public final static String GROUP_SUCCESS = "拼单成功";
  public final static String GROUP_WAIT = "请等待拼单队伍人数足够";
  public final static String GROUP_FAIL_REDIS = "拼单失败";
  public final static String GROUP_CONCEL_REDIS = "拼单已取消";
  ...
  public final static int GOODS_SEARCH_PAGE_LIMIT = 8;//搜索分页的默认条数(每页8条)

  public final static int ORDER_SEARCH_PAGE_LIMIT = 3;//我的订单列表分页的默认条数(每页3条)
  public final static int NOTICE_PAGE_LIMIT = 6;//公告列表分页的默认条数(每页6条)

  public final static int SELL_STATUS_UP = 0;//商品上架状态
  public final static int SELL_STATUS_DOWN = 1;//商品下架状态

  public static final String NOTICE_NOT_EXIT = "查询数据不存在";

  public final static String GROUP_EXIT_JOIN = "您已经加入该队伍";
}
